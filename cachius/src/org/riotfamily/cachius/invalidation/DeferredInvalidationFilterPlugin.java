...
/**
 * A {@link FilterPlugin} that defers cache invalidation to the
 * end of the filter chain.
 * 
 * @author Alf Werder [alf dot werder at artundweise dot de]
 * @since 8.0.1
 */
public class DeferredInvalidationFilterPlugin extends FilterPlugin {
	private CacheService cacheService;
	
	public DeferredInvalidationFilterPlugin() {
		// By default we seek to be the first on the filter chain.
