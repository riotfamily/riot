...
public final class Cache implements Serializable {
    ...
    public Cache(File cacheDir, int capacity, boolean enabled) {
        ...
        this.taggedItems = Collections.synchronizedMap(new HashMap());
    ...
    /**
     * Returns whether an item with the given key exists and is not new. An
     * item is new if it was not updated yet or if it was invalidated.
     */
    public boolean containsKey(String key) {
    	if (map.containsKey(key)) {
    		return !getItem(key).isNew();
    	}
    	return false;
    }
