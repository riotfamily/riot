 ...
 * 
 */
public class DropUniqueConstraint implements Refactoring {
	...
	public void alterModel(Database database) {
		database.getTable(table).removeUniqueConstraint(constraint);
	}
	
	public Script getScript(Dialect dialect) {
		return dialect.dropUniqueConstraint(table, constraint);
	}
