...
public class AnyIdAnyType extends AbstractType implements
	...
	private Serializable getId(ResultSet rs, String idColumnName,
			SessionImplementor session, Object owner, String entityName)
			throws SQLException {
		
		String s = getString(rs, idColumnName, session, owner); 
		return idFromString(entityName, s, session);
	}
	
	private Serializable idFromString(String entityName, String id, 
