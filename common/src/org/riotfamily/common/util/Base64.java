 ...
 * <p>
 * This class is copied from the <a href="http://www.springframework.org/webflow">Spring Webflow</a> framework
 * and originally based on Base64 encoder and decoder version 2.2.1 written by Robert Harder (<a
 * href="http://iharder.net/base64">http://iharder.net/base64</a>).
 * Modified by Erwin Vervaet to use the '.' character as padding character when using 
 * URL safe encoding, like in the Bouncy Castle URLBase64 encoder 
