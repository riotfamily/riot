 ...
 * 
 * ***** END LICENSE BLOCK ***** */
package org.riotfamily.components.command;
 ...
 * @since 6.4
 */
public class GotoListCommand extends PopupCommand {

	public static final String STYLE_CLASS = "link";
	
	private ComponentRepository componentRepository;
	
	public GotoListCommand(ComponentRepository componentRepository) {
	...
	protected String getUrl(CommandContext context) {
		...
		return context.getRequest().getContextPath() 
				+ componentRepository.getUrl(list);
	}
