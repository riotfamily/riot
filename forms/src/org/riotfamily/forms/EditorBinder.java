...
public class EditorBinder extends PropertyEditorRegistrySupport {
	...
	public Class getBeanClass() {
		return objectWrapper.getObjectClass();
	}
	...
	public void setBackingObject(Object backingObject) {
		...
		if (backingObject != null) {
			objectWrapper.setObject(backingObject);
		}
	}
	...
	private class EditorBindingImpl implements EditorBinding {
		...
		public Class getBeanClass() {
			return EditorBinder.this.getBeanClass();
		}
		...
		public Class getPropertyType() {
			return EditorBinder.this.getPropertyType(property);
		}
		
		public PropertyEditor getPropertyEditor() {
			return EditorBinder.this.getPropertyEditor(
