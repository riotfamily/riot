 ...
 * 
 * ***** END LICENSE BLOCK ***** */
package org.riotfamily.core.command.dialog;
...
import org.riotfamily.core.command.result.DialogResult;
...
public abstract class DialogCommand extends AbstractCommand {
	...
	public CommandResult execute(CommandContext context, Selection selection) {
		...
		form.setAttribute("listStateKey", context.getListState().getKey());
		...
		//return new DialogResult(context.getRequest().getContextPath() + formUrl);
