...
public abstract class FormScreenSupport extends AjaxFormController
		implements RiotScreen {
	...
	private String viewName = ResourceUtils.getPath(
			FormScreenSupport.class, "form.ftl");

	
	public FormScreenSupport(FormContextFactory formContextFactory,
